(function( $ ){
    ...
    $(function() {
        ...
        var $wrap = $('#uploader'),
            ...
            // 获取输入的信息
            $barcode = $wrap.find('#uploaderModalInputBarcode'),
            $sampleName = $wrap.find('#uploaderModalInputSampleName'),
            $gender = $wrap.find('#uploaderModalSelectGender'),
            $description = $wrap.find('#uploaderModalTextareaDescription'),
        ...
        uploader = WebUploader.create({
            ...
            // 限制上传的文件类型，暂时定为xls和xlsx
            // accept: {
            //     title: 'Excel',
            //     extensions: 'xlsx,vcf,csv'
            //     // mimeTypes: 'image/*'
        ...
        function updateStatus() {
            ...
            if ( state === 'ready' ) {
                ...
                if ( stats.uploadFailNum ) {
                    text = '已成功上传' + stats.successNum+ '份文件至服务器，'+
        ...
        //     // alert('chunk = ' + response.chunk);
        //     // alert('chunks = ' + response.chunks);
        //     // alert('url = ' + response._raw);
        //     alert("hello = " + ret);
        //     console.log(ret);
...
//
                ...
                $.ajax({
                    ...
                    success : function() {
                        ...
                        window.setTimeout(function() {
                            $('#mainContent').load('mySamples?currentPage=1&pageSize=15');
                        }, 300);
                    }
                });
            }, 100);
