...
$(document).ready(function(){
	window.actionsEvents = {
			    'click .fillin': function (e, value, row, index) {//请求填写问卷页面，传送pretempid
			        window.location.href="#/exp_fillin?tempid="+row.expTempId;
			    },
			    'click .subm_detail': function (e, value, row, index) {
			        window.location.href="#/exp_subm_detail?tempid="+row.expTempId;
			    },
			    'click .only_view': function (e, value, row, index) {
			    	window.location.href="#/exp_only_view?tempid="+row.expTempId;
			    }
	};	
